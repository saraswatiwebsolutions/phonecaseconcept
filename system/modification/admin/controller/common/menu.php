...
$data['text_fancy_product_designer'] = $this->language->get('text_fancy_product_designer');
				$data['text_fancy_products'] = $this->language->get('text_fancy_products');
				$data['text_products_design'] = $this->language->get('text_products_design');
				$data['text_categories_design'] = $this->language->get('text_categories_design');
				$data['text_fancy_cliparts'] = $this->language->get('text_fancy_cliparts');
				$data['text_cliparts'] = $this->language->get('text_cliparts');
				$data['text_clipart_categories'] = $this->language->get('text_clipart_categories');
				$data['text_fancy_fonts'] = $this->language->get('text_fancy_fonts');
				$data['text_fancy_settings'] = $this->language->get('text_fancy_settings');
 ...
 $data['fancy_fonts'] = $this->url->link('catalog/fnt_fonts', 'token=' . $this->session->data['token'], 'SSL');
            $data['cliparts'] = $this->url->link('catalog/fnt_clipart', 'token=' . $this->session->data['token'], 'SSL');
            $data['clipart_categories'] = $this->url->link('catalog/fnt_category_clipart', 'token=' . $this->session->data['token'], 'SSL');
            $data['fancy_products'] = $this->url->link('catalog/fnt_product_design', 'token=' . $this->session->data['token'], 'SSL');
            $data['fancy_categories'] = $this->url->link('catalog/fnt_category', 'token=' . $this->session->data['token'], 'SSL');
			$data['fancy_settings'] = $this->url->link('catalog/fnt_setting', 'token=' . $this->session->data['token'], 'SSL');
