...
<div class="container">
				...
				<style>
				.text-center img{width:<?php echo $image_cart_width;?>px;}
				</style>
    ...
    <div class="col-sm-6 col-md-3"><div class="orange-bg imgbox gray_background"><img  src="catalog/view/theme/default/image/step2.png"></div><p>Step 2: Upload Image</p></div>
    <div class="col-sm-6 col-md-3"><div class="green-bg imgbox gray_background"><img  src="catalog/view/theme/default/image/step3.png"></div><p>Step 3:  Add text</p></div>
