...
if(isset($this->session->data['cart-design'][$key])){
				$design = 1;
				$thumbnail = $this->session->data['cart-design'][$key]['thumbnail'];
				$product_id = $this->session->data['cart-design'][$key]['product_id'];
				$price_product_design = $this->session->data['cart-design'][$key]['price'];
				$price += (float)$this->session->data['cart-design'][$key]['price'];
				} else {
					$design = 0;
					$thumbnail = '';
					$product_id = 0;
...
if(isset($this->session->data['cart-design'][$key])){unset($this->session->data['cart-design'][$key]);}
	}
