<?php
class ControllerInformationEmailtofriend extends Controller {
	private $error = array();
	...
	public function index() {
		...
		print_r($this->request->server['REQUEST_METHOD']);
$ymail = $this->request->get['ymail'];
		$fmail = $this->request->get['fmail'];
		$msg = $this->request->get['msg'];
		$yname = $this->request->get['yname'];
		if ($this->request->server['REQUEST_METHOD'] == 'GET')  {
			
			
			
			
			$subject = sprintf( 'hjhjh');
